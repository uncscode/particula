...
number_of_new_resolved_particles = int(
    float(number_of_new_particles // single_resolved_particle)
)
print(
...
if number_of_new_resolved_particles > 0:
    ...
    squeeze_single_species_arrays(aerosol.particles)

    # keep concentration/mass 1-D for downstream dynamics
    aerosol.particles.concentration = np.squeeze(
...
total_particle_concentration_after_process = (
    aerosol.particles.get_total_concentration()
)
print(
