...
# Define the coagulation process using builders
coagulation_strategy_pmf = (
    par.dynamics.BrownianCoagulationBuilder()
    .set_distribution_type("discrete")
    .build()
)
coagulation_process_pmf = par.dynamics.Coagulation(
    coagulation_strategy=coagulation_strategy_pmf
)

coagulation_strategy_resolved = (
    par.dynamics.BrownianCoagulationBuilder()
    .set_distribution_type("particle_resolved")
    .build()
)
coagulation_process_resolved = par.dynamics.Coagulation(
    coagulation_strategy=coagulation_strategy_resolved
)

coagulation_strategy_pdf = (
    par.dynamics.BrownianCoagulationBuilder()
    .set_distribution_type("continuous_pdf")
    .build()
)
coagulation_process_pdf = par.dynamics.Coagulation(
    coagulation_strategy=coagulation_strategy_pdf
)
