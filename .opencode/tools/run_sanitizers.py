...
Usage:
    python3 .opencode/tools/run_sanitizers.py --sanitizer asan \\
        --executable ./a.out
    python3 .opencode/tools/run_sanitizers.py --sanitizer tsan \\
        --executable ./race --normal-duration 1.2
    python3 .opencode/tools/run_sanitizers.py --sanitizer ubsan \\
