...
type PlatformRateLimitReadCommand = "rate-limit";
...
export default tool({
  description: "Execute read-only adw platform rate-limit with strict validation.",
  args: {
    command: tool.schema.enum(["rate-limit"]).describe("Command to execute."),
