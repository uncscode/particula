  ...
  [
    "run_pytest_advanced",
    {
      fieldRoleAudit: [
        ...
        { field: "testPaths", role: "payload-bearing", notes: "Bounded ordered plural advanced test target operands." },
      ...
      auditNotes: [
        ...
        "Caller ini overrides remain prohibited; scoped assertion runs use the explicit coverage=false path.",
      ],
    },
  ],
  [
  ...
  [
    "run_linters",
    {
      fieldRoleAudit: [
        ...
        { field: "confirmed", role: "safety-field", notes: "Explicit confirmation gates mutating lint execution." },
        ...
        { field: "cwd", role: "safety-field", notes: "Repository/worktree execution root for relative lint targets." },
        { field: "mode", role: "safety-field", notes: "Explicit Ruff operation boundary must remain direct." },
        { field: "targetPaths", role: "safety-field", notes: "Ordered repository-relative Ruff target scope must remain direct." },
