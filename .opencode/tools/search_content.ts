...
Filtered search:  { contentPattern: "import", path: "adw", fileType: "py" }
Bounded output:   { contentPattern: "ERROR:", maxResults: 200, maxMatchesPerFile: 3 }
...
- No matches return a deterministic non-error message.`,
  ...
  args: {
    ...
    // Explicit advanced-only controls so this wrapper can fail closed.
