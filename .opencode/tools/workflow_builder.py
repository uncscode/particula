...
Examples:
    ...
    python3 .opencode/tools/workflow_builder.py list

    # Get workflow details
    python3 .opencode/tools/workflow_builder.py get --workflow-name patch

    # Create new workflow
    python3 .opencode/tools/workflow_builder.py create \\
        --workflow-name quick-deploy \\
        --description "Quick deployment workflow" \\
        --workflow-type custom

    # Add step to workflow
    python3 .opencode/tools/workflow_builder.py add_step \\
        --workflow-name quick-deploy \\
        --step-json '{"type":"agent","name":"Build","command":"/implement"}'

    # Validate workflow JSON
    python3 .opencode/tools/workflow_builder.py validate \\
        --workflow-json '{"name":"test","version":"1.0.0",...}'

See Also:
    .opencode/tools/workflow_builder.md - Complete documentation
