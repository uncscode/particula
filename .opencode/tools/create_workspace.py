...
Examples:
    ...
    python3 .opencode/tools/create_workspace.py 123

    # Create workspace for quick patch (skips test/review/docs)
    python3 .opencode/tools/create_workspace.py 456 --workflow-type patch

    # Resume existing workspace with known ADW ID
    python3 .opencode/tools/create_workspace.py 789 --adw-id abc12345

    # Get structured JSON output for programmatic use
    python3 .opencode/tools/create_workspace.py 101 --output json
"""
