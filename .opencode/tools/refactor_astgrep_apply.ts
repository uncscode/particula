...
const DESCRIPTION = `Apply AST-aware refactors using ast-grep.

This wrapper is mutating by design. It always appends --update-all.
For read-only preview mode, use refactor_astgrep_preview.
`;
