...
| M5: Numerical evidence | E2-F6, E2-F7 | Reproducible precision and stiffness reports publish concrete tables, commands, and recommendations for mass dtype policy and future condensation integration work. |
