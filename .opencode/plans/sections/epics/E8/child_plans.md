...
| E8-F3 | Registry Preallocation, Identity Reuse, and Byte Accounting | In Progress | P2 and P5 remain Not Started and block closeout. |
...
| E8-F8 | Graph-Capture Example, Runbook, Limitations, and Closeout | In Progress | T8 owns the native-CUDA example, operator runbook, limitations, documentation reconciliation, and fail-closed closeout. P1--P3 are implemented; P4 remains in progress pending required validation. E8-F8 and Epic H remain active/unshipped pending E8-F2, E8-F3, E8-F6, E8-F7/T7, and all designated-device final-revision H1--H11 evidence; no CUDA evidence is claimed. |
