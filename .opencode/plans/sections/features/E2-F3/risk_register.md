...
| --- | --- | --- | --- | --- |
| `E2-F2` CPU `EnvironmentData` schema is missing or changes late. | T3 could implement a mismatched GPU mirror. | Medium | Treat `E2-F2` as a hard dependency; confirm import path and fields before coding. | Implementer |
