...
- **Shipped P3 work (issue #1374):** Reconciled
  ...
  E5 and E5-F1 through E5-F9, their canonical statuses, and resolving artifact
   links. Its recorded completion date is 2026-07-20; P4 was subsequently
   rerun and recorded as the authoritative closeout on that date.
...
- **P4 closeout record (issue #1375, rerun 2026-07-20 after P3):** Replaced the
   superseded record with authoritative mandatory-command evidence and
   synchronized the E5/E5-F9 shipped projection with Epic F active.
