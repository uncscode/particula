...
P1 and P2 can run in parallel after API/evidence freeze. P3 requires stable
artifact paths from P1/P2 and E5-F7/F8. P4 requires P1-P3 plus shipped E5-F1
through E5-F8 and all release checks. A missing/failed/skipped-required gate
keeps E5 active and Epic F pending. Optional CUDA unavailability is not a
failure; required Warp CPU checks are failures when Warp is installed.
