...
- E5 roadmap completion and activation of Epic F depend on E5-F9's publication
  and closeout gate. The P4 closeout was rerun after P3 on 2026-07-20 and is the
  authoritative evidence for E5 shipped and Epic F active.
...
through E5-F8 and all release checks; its 2026-07-20 rerun follows P3.
Optional CUDA unavailability is not a failure; required Warp CPU checks were
failures when Warp was installed.
