...
| Example reintroduces direct kernels or hidden convenience transfers | Medium | High | Public-API-only review and exact conversion/sync call-count regression | P6 owner | Open |
