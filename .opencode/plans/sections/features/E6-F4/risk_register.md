...
| Invalid charge/configuration advances RNG or partially mutates slots | Low | High | Complete validation before allocation/initialization/launch; snapshot all caller state and identities in negative tests | GPU maintainer |
