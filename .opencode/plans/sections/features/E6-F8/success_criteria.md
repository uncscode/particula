...
- [ ] Every successful case conserves represented particle-plus-gas mass
  independently for each box and species; gas never becomes negative.
...
| Silent truncated finalized demand | Not applicable | 0 cases | Exhaustion tests |
