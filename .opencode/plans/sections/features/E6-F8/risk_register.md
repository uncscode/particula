...
| Full slots silently truncate finalized source demand | Medium | High | Require complete E6-F6 planning, reject residual demand before commit, and test every policy combination. | Particle owner |
