...
distinct thermodynamic environment per box. Track T5 defines the migration path
...
Parent epic: E2. This feature is track T5 for issue #1172. It depends on E2-F2
