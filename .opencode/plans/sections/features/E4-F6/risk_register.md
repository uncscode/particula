...
| Capture limitation is mistaken for support | High | Medium | Publish CPU capability-skip and CUDA strict-xfail context; do not claim replay support | P3/P5 implementer |
