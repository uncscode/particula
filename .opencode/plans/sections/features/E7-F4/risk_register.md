...
| Partial setup exposes leaked or usable incomplete state | Low | High | Construct privately and publish only after all validation, conversion, and allocation succeed | E7-F4 implementer |
