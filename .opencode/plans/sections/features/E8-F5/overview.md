...
E8-F5-P5 shipped for issue #1579. Its authoritative evidence record
captures passing focused, optional-CUDA clean-skip, untargeted coverage, and
documentation-contract results. Approved strict-equivalent worktree validation
passed with exit status 0; no production API or example changed.
