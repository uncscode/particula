...
- [x] Updated E6-F9 and E6 plan sections with #1449 P4 evidence and the
  fail-closed parent/epic projection; P3 transfer, no-Warp, and fallback-boundary
...
- [x] Ran the hardware-free
  ...
  documentation link/import/command and closeout-gate regression, plus
  `adw plans validate`, for #1449. The closeout projection remains blocked while
  E6-F2, E6-F5, E6-F6, and E6-F8 are incomplete.
