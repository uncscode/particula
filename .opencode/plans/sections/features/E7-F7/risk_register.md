...
| Communication leaves vapor pressure/saturation or diagnostics stale. | High: later physics consumes inconsistent state. | Medium | Integrate explicit invalidation edges into E7-F5 and test call order. | P5 implementer |
