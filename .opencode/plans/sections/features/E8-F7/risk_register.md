...
| Workload state diverges between modes. | Captured/uncaptured comparison is invalid. | Medium | Rebuild from the same deterministic fixture and validate exact dimensions, configuration, and step counts. | Benchmark owner |
