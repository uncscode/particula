...
| Date | Change | Author |
|------|--------|--------|
| 2026-07-18 | Completed E5-F5-P4 for issue #1355: recorded the delivered documentation for the exact direct particle-resolved ST1956 singleton, keyword-only positive-finite dissipation/fluid-density scalar or active-device `wp.float64` per-box inputs, caller ownership, Warp CPU baseline, optional CUDA, and P2-aware mixed-mask rejection. E5-F6/F7/F9 remain downstream handoffs. | plan-update-full |
