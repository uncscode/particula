...
- **P1:** Co-located property tests compare ideal molar and kappa activity to
  independent CPU/NumPy references for pure/mixed, wet/dry, zero-solute, and
  multi-solute particles.
- **P2:** Co-located tests cover static compatibility, selected composition
  weighting, zero weights, and effective surface input to Kelvin formulas.
