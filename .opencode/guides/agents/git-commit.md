...
1. Reads commit conventions from `adw-docs/commit_conventions.md`
...
1. **Keep commit conventions current**: Update `adw-docs/commit_conventions.md`
...
- **Commit Conventions Guide**: `adw-docs/commit_conventions.md` - Format specification
