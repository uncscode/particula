...
- **Tool Access**:
  ...
  - Atomic git wrappers - `git_diff`, `git_stage`, `git_commit`, `git_branch`,
    `git_merge`, `git_worktree`
...
- `adw-docs/linting_guide.md` - Linting tools, configuration, standards
- `adw-docs/commit_conventions.md` - Commit message format and rules
- `adw-docs/pr_conventions.md` - Pull request title, body, linking format
- `adw-docs/code_style.md` - General code style conventions
...
5. **Document conventions**: Keep `adw-docs/*.md` guides up to date
...
- **Linting Guide**: `adw-docs/linting_guide.md` - Linting standards and tools
- **Commit Conventions**: `adw-docs/commit_conventions.md` - Commit message format
- **PR Conventions**: `adw-docs/pr_conventions.md` - Pull request format
...
- **Platform Operations**: `.opencode/tools/platform_operations.ts` - Platform operations tool (PRs, issues, labels)

### Subagent References
- **Linter Subagent**: `adw-docs/agents/linter.md` - Linting subagent guide
- **Git-Commit Subagent**: `adw-docs/agents/git-commit.md` - Commit subagent guide
