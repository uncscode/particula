...
- **Follows repository conventions** from `adw-docs/` guides
...
See `adw-docs/agents/git-commit.md` for complete git-commit documentation.
...
> to run [`adw spec list`](https://github.com/Gorkowski/Agent/blob/main/README.md#spec-state-commands) for the full
...
- **Keep `adw-docs/` guides current** - agent relies on these
...
- **Plan-Work Agent**: `adw-docs/agents/plan-work.md` - Creates plans that execute-plan implements
- **Tester Agent**: `.opencode/agent/tester.md` - Called automatically for validation
- **Architecture**: `adw-docs/architecture_reference.md` - Patterns agent follows
- **Code Style**: `adw-docs/code_style.md` - Conventions agent adheres to
- **Testing Guide**: `adw-docs/testing_guide.md` - Test framework details
