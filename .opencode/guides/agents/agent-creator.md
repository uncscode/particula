...
- **Integrate an agent with repository conventions** by referencing adw-docs/ guides
...
2. **Convention Integration**: Ensures agents reference repository guides (adw-docs/)
...
- `adw-docs/architecture_reference.md` - For architecture/planning agents
- `adw-docs/code_style.md` - For implementation agents
- `adw-docs/testing_guide.md` - For testing-related agents
- `adw-docs/linting_guide.md` - For code quality agents
- `adw-docs/docstring_guide.md` - For documentation agents
- `adw-docs/documentation_guide.md` - For doc format standards
- `adw-docs/review_guide.md` - For review agents
- `adw-docs/dev-plans/features/` - For feature development agents
...
- Supporting documentation (for you to save to `adw-docs/agents/`)
...
- **`get_datetime`** - For agents that need timestamps (UTC default; America/Denver when `localtime` is true)
...
2. **Design decisions**:
   ...
   - **Context**: `adw-docs/security_guide.md`, OWASP Top 10
   - **Tools**: None (analysis only)

3. **Output**:
   - Agent definition: `security_reviewer.md`
   - Documentation: `adw-docs/agents/security-reviewer.md`
...
2. **Design decisions**:
   ...
   - **Context**: `adw-docs/documentation_guide.md`, `adw-docs/docstring_guide.md`
   - **Tools**: `get_version`, `get_datetime` (UTC or America/Denver via `localtime`)

3. **Output**:
   - Agent definition: `doc_updater.md`
   - Documentation: `adw-docs/agents/doc-updater.md`
...
**Invocation**:
```
"I need an agent to implement new features by reading the feature specs in adw-docs/dev-plans/features/ and following our architecture patterns"
```
...
2. **Design decisions**:
   ...
   - **Context**: `adw-docs/dev-plans/features/`, `adw-docs/architecture_reference.md`, `adw-docs/testing_guide.md`
   - **Tools**: `run_pytest`, `adw`

3. **Output**:
   - Agent definition: `feature_developer.md`
   - Documentation: `adw-docs/agents/feature-developer.md`
...
2. **Design decisions**:
   ...
   - **Context**: `adw-docs/testing_guide.md`, `adw-docs/code_style.md`
   - **Tools**: `run_pytest` (to validate generated tests)

3. **Output**:
   - Agent definition: `test_generator.md`
   - Documentation: `adw-docs/agents/test-generator.md`
...
4. **Reference conventions**: Always link to repository guides in adw-docs/
...
**Solution**: The Agent Creator automatically includes references to adw-docs/ guides. If missing, explicitly request: "Ensure this agent references adw-docs/code_style.md and testing_guide.md".
...
- **Repository Conventions**: `adw-docs/` directory
- **Agent Templates**: `adw/templates/opencode_config/agent/`
- **Feature Development Guide**: `adw-docs/dev-plans/features/`
...
```
"Ensure the agent follows our testing conventions from adw-docs/testing_guide.md"
```
...
3. **Save documentation** - Copy to `adw-docs/agents/[name].md`
