...
4. **Document style guide**: Keep `adw-docs/linting_guide.md` up to date
...
- **Linting Guide**: `adw-docs/linting_guide.md` - Repository linting standards
...
- **Testing Guide**: `adw-docs/testing_guide.md` - Testing standards
- **Code Style Guide**: `adw-docs/code_style.md` - Coding conventions
