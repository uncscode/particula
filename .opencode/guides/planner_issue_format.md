# Planner Issue Format

This is the canonical format for `type:planner` issue creation and downstream
scope analysis.

## Issue Metadata

- Title prefix: `[Planner]: `
- Labels: `agent`, `blocked`, `model:default`, `type:planner`
- Assignees: none by default
...
<!-- ADW Agent: Use `adw_plans_read({"command": "list", "options": "json"})` for discovery.
Use `adw_plans_read({"command": "show", "plan_id": "<id>", "options": "json"})` for verification. -->
