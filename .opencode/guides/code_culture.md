...
This document describes the cultural principles and development philosophy for adw.

> **See Also:** [Theory: 100-Line Rule](../docs/Theory/100-line-rule.md),
> [Theory: Code Culture](../docs/Theory/code-culture.md),
> [Theory: Agent Developer Workflows](../docs/Theory/agent-developer-workflows.md)
...
See `plans/templates/feature/` and `plans/templates/maintenance/` for templates.
...
- Aim for 80% test coverage (enforced in CI and `pyproject.toml`)
