...
### Repository-Specific Agent Documentation (`.opencode/guides/`)
...
- .opencode/guides/conditional_docs.md
  - Conditions:
...
- .opencode/plans/
  - Conditions:
  - When planning or updating epics, features, or maintenance priorities
  - When deciding whether to author an epic vs. feature vs. maintenance plan
  - When linking issues to roadmap documents or archives
