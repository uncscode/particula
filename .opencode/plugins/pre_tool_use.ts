  ...
  return {
    "tool.execute.before": async (input: any, output: any) => {
      try {
        ...
        // Coerce undefined/null args to {} so Zod .default() values are
        // applied when the AI omits optional parameters.
        // (Same root cause as opencode#9020 / #20019 — fixed for MCP tools
        // in #11203 but not for custom plugin tools.)
        if (output.args == null) {
          output.args = {};
        }
