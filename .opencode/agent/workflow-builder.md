---
description: >-
  Helps create and modify ADW workflow JSON files with validation.
  Interactive workflow builder that guides users through step-by-step workflow creation
  with real-time validation using the workflow_builder tool.
mode: primary
tools:
