...
description: >-
  ...
  implementation is complete. This primary agent coordinates specialized
  documentation subagents to ensure all docs, docstrings, examples, and
  architecture documentation stay current with code changes.
  ...
  - Commit all documentation changes via git-commit subagent
...
- **Commits all changes** - via git-commit subagent
...
| **docs-feature** | Update feature documentation | `docs/Agent/feature/*.md` |
| **docs-maintenance** | Update maintenance docs | `docs/Agent/maintenance/*.md` |
...
| **git-commit** | Commit changes | Git operations |
...
todowrite({
  "todos": [
    ...
    {
      "id": "N",
      "content": "Invoke git-commit subagent",
      "status": "pending",
      "priority": "high"
    }
  ]
...
task({
  ...
  "prompt": f"""Document feature in docs/Agent/feature/.
...
**Expected:** `GIT_COMMIT_SUCCESS`, `GIT_COMMIT_SKIPPED`, or `GIT_COMMIT_FAILED`
...
5. Invoke subagents:
   ...
   - git-commit → Commits "docs: add authentication documentation"
