---
description: >-
  Use this agent to implement plans and specifications by following repository
  conventions and best practices. This agent should be invoked when:

  - The user provides a plan or specification to implement

  - Code needs to be written following the repository's architecture, style, and
  testing guidelines

  - Implementation requires consulting docs/Agent/ guides for conventions

  - The user asks to "implement", "code", "execute the plan", or "build
  according to spec"
  ...
  - User: "Implement this feature specification"
    Assistant: "I'll use the implementor agent to implement the feature according to our repository guidelines"

  - User: "Execute the plan we discussed and implement the changes"
    Assistant: "Let me invoke the implementor agent to execute the plan following our established conventions"

  - User: "Implement the database schema changes according to the spec"
    Assistant: "I'm going to use the implementor agent to implement the database schema changes according to our architecture and coding standards"
mode: all
---
