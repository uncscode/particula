---
description: "Conditional Documentation Guide"
---
...
### Repository-Specific Agent Documentation (docs/Agent/)
...
- docs/Agent/architecture/architecture_outline.md
  - Conditions:
...
- docs/Agent/architecture/decisions/
  - Conditions:
