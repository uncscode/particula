...
def test_get_constants():
    ...
    assert GAS_CONSTANT.units == BOLTZMANN_CONSTANT.units * AVOGADRO_NUMBER.units
    assert GAS_CONSTANT.magnitude == BOLTZMANN_CONSTANT.magnitude * AVOGADRO_NUMBER.magnitude
    assert BOLTZMANN_CONSTANT.units == u.m**2 * u.kg / u.s**2 / u.K
