...
def get_relative_velocity_variance(
    ...
    ----------
        ...
        - particle_inertia_time_1 : Inertia timescale of droplet 1 [s].
        - particle_inertia_time_2 : Inertia timescale of droplet 2 [s].
    ...
    """
    rms_velocity_1 = compute_rms_fluctuation_velocity(
        turbulence_intensity,
        particle_inertia_time_1,
        b1,
        b2,
        d1,
        d2,
    ...
    rms_velocity_2 = compute_rms_fluctuation_velocity(
        turbulence_intensity,
        particle_inertia_time_2,
        b1,
        b2,
        d1,
        d2,
    ...
    return rms_velocity_1 + rms_velocity_2 - 2 * cross_correlation
...
def compute_cross_correlation_velocity(
    ...
    """
    Compute the cross-correlation of the fluctuating velocities of droplets 1 and 2.
    ...
    f2_r = get_f2_longitudinal_velocity_correlation(
        collisional_radius, particle_inertia_time_1, particle_inertia_time_2
    )

    phi_c1_e1 = get_phi_ao2008(
        c1, e1, particle_inertia_time_1, particle_inertia_time_2
    )
    phi_c1_e2 = get_phi_ao2008(
        c1, e2, particle_inertia_time_1, particle_inertia_time_2
    )
    phi_c2_e1 = get_phi_ao2008(
        c2, e1, particle_inertia_time_1, particle_inertia_time_2
    )
    phi_c2_e2 = get_phi_ao2008(
        c2, e2, particle_inertia_time_1, particle_inertia_time_2
    )

    return (
        (turbulence_intensity**2 * f2_r)
        / (particle_inertia_time_1 * particle_inertia_time_2)
        * (
            b1 * d1 * phi_c1_e1
            - b1 * d2 * phi_c1_e2
            - b2 * d1 * phi_c2_e1
