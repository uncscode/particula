...
def test_dynamic_viscosity_normal_conditions() -> None:
...
def test_dynamic_viscosity_high_temperature() -> None:
...
def test_dynamic_viscosity_low_temperature() -> None:
...
def test_dynamic_viscosity_reference_values() -> None:
...
def test_dynamic_viscosity_zero_temperature() -> None:
    """Test for error handling with zero temperature."""
    with pytest.raises(ValueError):
        get_dynamic_viscosity(0)


def test_dynamic_viscosity_negative_temperature() -> None:
