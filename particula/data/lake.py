...
#         add_processed_datastream: Adds a processed datastream to the DataLak
#         initialise_datastream: Initialise a datastream using the settings in
#             the DataLake object.
#         reaverage_datastream: Reaverages the data in the specified datastrea
...
#                 be added to the DataLake. The keys of the dictionary should
...
#                 in hours. Default is 0. : add UTC time zone support
#         """
...
#         Parameters:
#         ----------
#             header_print_count (int, optional): The number of headers to pri
...
#         ----------
#             None.
#         do: add option for specific datastreams
#         """
