...
import pytest
import numpy as np
from particula.next.particles.properties import diffusive_knudsen_number
...
def test_diffusive_knudsen_number_array():
    ...
    coulomb_potential_ratio = np.array([0.5, 0.0])  # different charges
    temperature = 298.15
    ...
    expected_result = np.array([[5.35520625e-16, 9.72085031e-17],
                                [1.14745697e-16, 4.27728106e-15]])
