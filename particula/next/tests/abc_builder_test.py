...
def test_builder_init(builder):
    assert builder.required_parameters == [
        'param1', 'param2'], "Initialization of required parameters failed"


def test_check_keys_valid(builder):
...
def test_check_keys_missing_required(builder):
...
def test_check_keys_invalid(builder):
...
def test_pre_build_check_complete(builder):
    builder.param1 = 10
    builder.param2 = 20
    try:
