...
import pytest
import numpy as np
from particula.next.gas.properties import thermal_conductivity
...
def test_thermal_conductivity_normal():
    ...
    assert pytest.approx(thermal_conductivity(temperature)
...
def test_thermal_conductivity_array():
    ...
    result = thermal_conductivity(temperatures)
