...
import pytest
from particula.next.gas.properties import dynamic_viscosity


def test_dynamic_viscosity_normal_conditions():
    """Test dynamic viscosity under normal conditions."""
    assert pytest.approx(dynamic_viscosity(
...
def test_dynamic_viscosity_reference_values():
    ...
    assert pytest.approx(dynamic_viscosity(300, 1.85e-5, 300),
