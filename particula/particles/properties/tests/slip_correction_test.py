...
def test_cunningham_slip_correction_basic() -> None:
    ...
    assert np.isclose(get_cunningham_slip_correction(knudsen_number), expected)


def test_cunningham_slip_correction_array() -> None:
    ...
    np.testing.assert_allclose(
        get_cunningham_slip_correction(knudsen_numbers), expected
    )


def test_cunningham_slip_correction_high_value() -> None:
...
def test_cunningham_slip_correction_low_value() -> None:
...
def test_cunningham_slip_correction_negative_value() -> None:
...
def test_cunningham_slip_correction_type_error() -> None:
