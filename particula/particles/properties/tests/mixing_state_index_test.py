...
def test_internal_mixture_returns_one() -> None:
...
def test_external_mixture_returns_zero() -> None:
...
def test_mixture_identical_particles_returns_one() -> None:
...
def test_single_particle_returns_one() -> None:
...
def test_zero_total_mass_returns_nan() -> None:
