...
def test_validate_nonpositive() -> None:
...
def test_validate_nonnegative() -> None:
...
def test_validate_nonzero() -> None:
...
def test_none_skips_validation() -> None:
