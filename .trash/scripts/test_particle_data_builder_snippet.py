"""Pytest script that prints ParticleDataBuilder outputs for inspection."""
...
def test_particle_data_builder_shapes_printed() -> None:
    builder = (
        ParticleDataBuilder()
    ...
    # Assertion to keep pytest satisfied while keeping output visible
